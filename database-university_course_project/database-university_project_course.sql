...
CREATE TABLE `courses` (
  ...
  UNIQUE KEY `course_id_UNIQUE` (`courses_id`)
...
INSERT INTO `courses` VALUES (1,'Swedish'),(2,'Chinese'),(3,'Japanese'),(4,'Euskera'),(5,'Deutsch'),(6,'Englisch'),(7,'Russian'),(8,'French');
...
-- Dump completed on 2023-11-10  0:26:04
